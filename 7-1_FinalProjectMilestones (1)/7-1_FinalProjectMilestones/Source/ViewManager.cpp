...
namespace
{
	...
	//Void scrollcalback
	//this function controls the speed of the camera
	void Scroll_Callback(GLFWwindow* window, double xoffset, double yoffset)
	{
		if (g_pCamera)
		{
			...
			//limit speed from too fast or too slow
...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	//scroll wheel camera speed adjustment
...
void ViewManager::PrepareSceneView()
{
	...
	if (bOrthographicProjection)
	{
		...
		// Optional: Adjust camera position and orientation to look straight down
		// Example:
	...
	else
	{
		...
		// Optional: Restore default camera view if needed
	}

	// Upload view and projection matrices to shader after final values are set
	if (m_pShaderManager)
	{
